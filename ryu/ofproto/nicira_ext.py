...
NXAST_INC_TCP_SEQ = 80
NXAST_DEC_TCP_SEQ = 81
NXAST_INC_TCP_ACK = 82
NXAST_DEC_TCP_ACK = 83
...
NX_ACTION_INC_TCP_SEQ_PACK_STR = '!HHIH2xI'
NX_ACTION_INC_TCP_SEQ_SIZE = 16
assert calcsize(NX_ACTION_INC_TCP_SEQ_PACK_STR) == NX_ACTION_INC_TCP_SEQ_SIZE

NX_ACTION_DEC_TCP_SEQ_PACK_STR = '!HHIH2xI'
NX_ACTION_DEC_TCP_SEQ_SIZE = 16
assert calcsize(NX_ACTION_DEC_TCP_SEQ_PACK_STR) == NX_ACTION_DEC_TCP_SEQ_SIZE

NX_ACTION_INC_TCP_ACK_PACK_STR = '!HHIH2xI'
NX_ACTION_INC_TCP_ACK_SIZE = 16
assert calcsize(NX_ACTION_INC_TCP_ACK_PACK_STR) == NX_ACTION_INC_TCP_ACK_SIZE

NX_ACTION_DEC_TCP_ACK_PACK_STR = '!HHIH2xI'
NX_ACTION_DEC_TCP_ACK_SIZE = 16
assert calcsize(NX_ACTION_DEC_TCP_ACK_PACK_STR) == NX_ACTION_DEC_TCP_ACK_SIZE
